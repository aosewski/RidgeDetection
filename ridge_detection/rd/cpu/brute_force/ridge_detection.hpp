 ...
 *
 * @tparam     T     Points coordinate data type
 */
template<typename T>
...
public:
	...
	/// Decides whether or not to print out progress information and draw graphs
	bool verbose_;
	/// Decides whether or not to perform final chosen points ordering
	bool order_;
	 ...
	 * @param      r1    Algorithm parameter. Radius used for choosing points and in evolve phase.
	 ...
	 * @param      S        table for choosen points
	 * @param      r1       Algorithm parameter. Radius used for choosing points and in evolve
	 *                      phase.
	 * @param      r2       Algorithm parameter. Radius used for decimation phase.
	 * @param      dim      points dimension
	 */
