...
/**
 * @brief      Class representing a tree with nodes storing tiles with points falling into its
 *             boundaries.
 *
 * @see        LocalSamplesTile
 *
 * @tparam     T     Tile point's coordinates data type.
 */
template <typename T>             
...
protected:
    ...
    /// Vector storing shared pointers to leaf nodes tiles.
