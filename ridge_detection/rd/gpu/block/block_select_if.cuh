 ...
 *
 * This file is an integral part of the master thesis entitled: "Elaboration and implementation in
 * CUDA technology parallel version of estimation of multidimensional random variable density
 * function ridge detection algorithm." , which is conducted under the supervision of prof. dr hab.
 * inż. Marek Nałęcz.
 *
