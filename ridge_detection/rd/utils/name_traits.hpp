...
std::string getBlockStoreAlgName(cub::BlockStoreAlgorithm STORE_ALGORITHM)
{
    ...
    {
        case cub::BLOCK_STORE_DIRECT: 
            return std::string("BLOCK_STORE_DIRECT");
        case cub::BLOCK_STORE_VECTORIZE: 
            return std::string("BLOCK_STORE_VECTORIZE");
        case cub::BLOCK_STORE_TRANSPOSE: 
            return std::string("BLOCK_STORE_TRANSPOSE");
        case cub::BLOCK_STORE_WARP_TRANSPOSE: 
            return std::string("BLOCK_STORE_WARP_TRANSPOSE");
        case cub::BLOCK_STORE_WARP_TRANSPOSE_TIMESLICED: 
            return std::string("BLOCK_STORE_WARP_TRANSPOSE_TIMESLICED");
...
std::string getBlockLoadAlgName(cub::BlockLoadAlgorithm LOAD_ALGORITHM)
{
    ...
    {
        case cub::BLOCK_LOAD_DIRECT:
            return std::string("BLOCK_LOAD_DIRECT");
        case cub::BLOCK_LOAD_VECTORIZE:
            return std::string("BLOCK_LOAD_VECTORIZE");
        case cub::BLOCK_LOAD_TRANSPOSE:
            return std::string("BLOCK_LOAD_TRANSPOSE");
        case cub::BLOCK_LOAD_WARP_TRANSPOSE:
            return std::string("BLOCK_LOAD_WARP_TRANSPOSE");
        case cub::BLOCK_LOAD_WARP_TRANSPOSE_TIMESLICED:
            return std::string("BLOCK_LOAD_WARP_TRANSPOSE_TIMESLICED");
