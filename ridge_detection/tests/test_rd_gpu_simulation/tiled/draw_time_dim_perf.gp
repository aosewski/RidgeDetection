...
set xlabel 'wymiar punktów' offset 0,0.5
set logscale y
...
plot dataFile1 i  0 u 2:($14/1000.0) t '(f) GTX TITAN'  w lp ls 19, \
          ...
          ''   i  2 u 2:($14/1000.0):($15/1000.0):($16/1000.0) notitle w yerrorbars ls 2
