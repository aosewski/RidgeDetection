...
static const std::string LOG_FILE_NAME_SUFFIX = "_io-timings_v2.txt";
...
class AgentTileProcessing
{
        ...
        cub::Int2Type<rd::ROW_MAJOR>    privateMemLayout)
    {
        ...
        BlockTileLoadT::loadTile2Row(d_nativeInputSamples + blockOffset * DIM, samples, stride);
        BlockTileStoreT::storeTile2Row(d_nativeOutputSamples + blockOffset * DIM, samples, stride);
    }
        ...
        cub::Int2Type<rd::COL_MAJOR>    privateMemLayout)
    {
        ...
        BlockTileLoadT::loadTile2Col(d_nativeInputSamples + blockOffset * DIM, samples, stride);
        BlockTileStoreT::storeTile2Col(d_nativeOutputSamples + blockOffset * DIM, samples, stride);
    }
    ...
    {
        SampleT     samples[DIM][POINTS_PER_THREAD];
        BlockTileLoadT::loadTile2Col(d_nativeInputSamples + blockOffset, samples, stride);
        BlockTileStoreT::storeTile2Col(d_nativeOutputSamples + blockOffset, samples, stride);
    ...
    {
        SampleT     samples[POINTS_PER_THREAD][DIM];
        BlockTileLoadT::loadTile2Row(d_nativeInputSamples + blockOffset, samples, stride);
        BlockTileStoreT::storeTile2Row(d_nativeOutputSamples + blockOffset, samples, stride);
    }
    ...
    {
        SampleT     samples[POINTS_PER_THREAD][DIM];
        BlockTileLoadT::loadTile2Row(d_nativeInputSamples + blockOffset * DIM, validPoints, samples, stride);
        BlockTileStoreT::storeTile2Row(d_nativeOutputSamples + blockOffset * DIM, validPoints, samples, stride);
    }
    __device__ __forceinline__ void consumeTile(
        OffsetT                     blockOffset,
        int                         validPoints,
    ...
    {
        SampleT     samples[DIM][POINTS_PER_THREAD];
        BlockTileLoadT::loadTile2Col(d_nativeInputSamples + blockOffset * DIM, validPoints, samples, stride);
        BlockTileStoreT::storeTile2Col(d_nativeOutputSamples + blockOffset * DIM, validPoints, samples, stride);
    }
    ...
    {
        SampleT     samples[DIM][POINTS_PER_THREAD];
        BlockTileLoadT::loadTile2Col(d_nativeInputSamples + blockOffset, validPoints, samples, stride);
        BlockTileStoreT::storeTile2Col(d_nativeOutputSamples + blockOffset, validPoints, samples, stride);
    }
    ...
    {
        SampleT     samples[POINTS_PER_THREAD][DIM];
        BlockTileLoadT::loadTile2Row(d_nativeInputSamples + blockOffset, validPoints, samples, stride);
        BlockTileStoreT::storeTile2Row(d_nativeOutputSamples + blockOffset, validPoints, samples, stride);
    }
...
std::string createFinalGraphDataFile()
{
    ...
    graphDataFile << typeid(T).name() << "_" << g_devName << "_graphData_v2.dat";
...
void drawFinalGraph(std::string graphDataFilePath)
{
        ...
        std::ostringstream graphName;
        graphName << typeid(T).name() << "_" << g_devName << "_bandwidths_v2.png";
